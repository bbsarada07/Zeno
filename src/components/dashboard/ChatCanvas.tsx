...
export const ChatCanvas: React.FC = () => {
  ...
  const quickActionChips = [
    { label: 'Check ATS resume score', icon: '🎓', prompt: 'Check ATS resume score' },
    { label: 'Microsoft SDE placement roadmap', icon: '🎯', prompt: 'Microsoft SDE placement roadmap' },
    { label: 'Mock recruiter simulation', icon: '🎙️', prompt: 'Mock recruiter simulation' },
